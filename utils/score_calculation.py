...
def get_ood_scores_odin_imagenet(loader, net, bs, ood_num_examples, T, noise, in_dist=False):
    _score = []
    _right_score = []
    _wrong_score = []
    ...
    while input is not None:
        ...
        odin_score = ODIN(input, output, net, T, noise)
        ...
        if in_dist:
            ...
            _right_score.append(-np.max(odin_score[right_indices], axis=1))
            _wrong_score.append(-np.max(odin_score[wrong_indices], axis=1))
